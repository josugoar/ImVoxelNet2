...
class ImBEVNeck(BaseModule):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.model = nn.Sequential(
            ...
            ConvModule(in_channels=in_channels * 2,
            ...
            ConvModule(in_channels=in_channels * 4,
...
class ResModule(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        super().__init__()
        self.conv0 = ConvModule(in_channels=in_channels,
                                out_channels=out_channels,
                                kernel_size=3,
                                stride=stride,
                                padding=1,
        ...
        self.conv1 = ConvModule(in_channels=out_channels,
                                ...
                                act_cfg=None)
        if stride != 1:
            self.downsample = ConvModule(in_channels=in_channels,
                                         out_channels=out_channels,
                                         kernel_size=1,
                                         stride=stride,
                                         padding=0,
